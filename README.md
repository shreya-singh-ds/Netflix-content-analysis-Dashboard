...
🔗 **[Click here to explore the interactive dashboard](YOUR_TABLEAU_PUBLIC_LINK)**
...
| Genre Chart | Top genres broken down by movie vs TV show |
| Trend Chart | How content was added to Netflix month by month |
| % Trend Chart | The shifting balance between movies and shows over time |

You can filter everything by **Country, Date Added, Release Year, and Director** — so it's easy to explore specific slices of the data.
...
2. Use the filters on the right to narrow down by country, year, or director
...
| File | What it is |
|---|---|
| `Netflix_understanding.twbx` | The Tableau workbook with data + dashboard built in |
...
*Made by Shreya Singh · [LinkedIn](YOUR_LINKEDIN_URL) · [Tableau Public](YOUR_TABLEAU_PUBLIC_PROFILE)*
